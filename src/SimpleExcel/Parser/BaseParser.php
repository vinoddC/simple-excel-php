    ...
    */
    public function isFileReady($file_path) {
        ...
        // extension valid?
            ...
            throw new \Exception('File extension '.pathinfo($file_path, PATHINFO_EXTENSION).' doesn\'t match with '.$this->file_extension, SimpleExcelException::FILE_EXTENSION_MISMATCH);
